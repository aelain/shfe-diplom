    ...
    <div className="popup popup_add-film hidden">
      <section className="popup__container">
        <div className="popup__content">
          ...
          <form className="popup__form" onSubmit={event => onAddFilm(event, onDataChange)}>
            <div className="popup__settings">
              ...
              <input className="admin__input popup__input" type="number" name="filmDuration" id="film-duration" required />
